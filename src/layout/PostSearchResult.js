...
import { fetchCoursesFromDB } from "../Store/Action/Post";

class PostSearchResult extends Component {

  componentDidMount() {
    this.props.postPagination();
  }
  render() {
    return (
      <section className="section__result-pages">
                ...
                <div className="rp-header-navigation header-navigation__container">
                  <div className="header-navigation__items d-flex">
                    <div className="header-navigation--item is-actived">
                      <a className="hn-item--text" href="/ket-qua">
                        Tất cả
                      </a>
                    </div>
                    <div className="header-navigation--item">
                      <a className="hn-item--text" href="/ket-qua/thong-tin">
                        Thông tin
                      </a>
                    </div>
                    <div className="header-navigation--item">
                      <a className="hn-item--text" href="/ban-do">
                        Bản đồ
                      </a>
                    </div>
                    <div className="header-navigation--item">
                      <a className="hn-item--text" href="/ket-qua/bang-gia">
                        Bảng giá
                      </a>
                    </div>
                    ...
                    <div className="search-result__item-container d-flex">
                      ...
                      <div className="sr-item__poster">
                        <div className="poster--avatar">
                          <a href="#">
                            <img
                              src="../../../assets/img/Rectangle 97.png"
                              alt
                            />
                          </a>
                        </div>
                        ...
                        <div className="item-details__container">
                            ...
                            <div className="ids-title__content">
                              <div className="ids-title--header d-flex">
                                ...
                                <div className="title--rate d-flex align-items-center">
                                  <span>[Chung cư </span>
                                  <span className="title_rate--highlight">
                                    {" "}
                                    4,5+{" "}
                                  </span>
                          ...
                          <div className="item-details__post">
                            <div className="ids-post--title">
                              <a href="#">
                                Tòa nhà Lý Chính Thắng đang trong giai đoạn hoàn
                                thiện
                              </a>
                            </div>
                            <div className="ids-post--content">
                              <span>
                                Ngày 10-12/05: Có 123 thông báo kế hoạch lựa
                                chọn nhà thầu chậm .... 1527/QĐ-UBND ngày
                                14/02/2019; KHLCNT của Ban Quản lý dự án đầu tư
                                xây .... KHLCNT của Sở Tài chính tỉnh Hưng ….
                                cho dự án “Mua sắm thiết bị định .... Hạng mục:
                                Xóm Ao Vàng, Cổ Rùa, Gò Chè, Phúc Lộc, Quyết
                                Thắng, Tân ...
                              </span>
                            </div>
                          </div>
                      ...
                      <div className="sr-item__details">
                        <div className="item-details__container">
                          ...
                          <div className="item-details__post">
                            <div className="ids-post--title">
                              <a href="#">
                                Lý Chính Thắng khu đô thị tương lai đang trong
                          ...
                          <div className="item-details__title">
                            <div className="ids-title__content">
                              ...
                              <p className="mb-0 ids-title--category">
                                ...
                                cùng với{" "}
                                <a href="#" className="ids-title--category">
                                  Homekeys 97891
                                </a>{" "}
                                cập nhật trạng thái{" "}
                                <span className="red bold">Bán</span>
                              </p>
                              <p className="mb-0 ids-title--date-posted">
                                10 ngày trước
                              </p>
                              ...
                              <div className="post-content">
                                <div className="top">
                                  ...
                                  <span
                                    ...
                                    style={{ color: "#189655" }}
                                  >
                                    60,78m<sub className="subtop">2</sub>
                                  </span>{" "}
                                  <span
                                    className="#"
                                    style={{ color: "#189655" }}
                                  >
                                    150,0m<sub className="subtop">2</sub>{" "}
                                ...
                                <div className="location">
                                  711014P0001- Hồ Thị Kỷ, Phường 4, Quận 6, Hồ
                                  Chí Minh
                                </div>
                                <div className="actions">
                                  <button className="btn">
                                    <img
                                      src="../../assets/img/bxs-edit.svg"
                                      alt
                                    />
                                  </button>
                                  <button className="btn">
                                  ...
                                  <button className="btn">
                                    <img
                                      src="../../assets/img/baseline-map-24px.svg"
                                      alt
                                    />
                                  </button>
                                </div>
                                ...
                                <div className="info -top">
                                  <span>Nhà xây dựng</span>{" "}
                                  <span>Bàn giao T2.2010</span>{" "}
                                  <span>Đã hoàn công</span> <span>Sổ hồng</span>
                                </div>
                                <div className="info -ban">
                                  <span className="status -ban">Bán</span>{" "}
                                  <span>
                                    Avalue: <strong>2,65 tỷ</strong>
                                  </span>{" "}
                                  <span>
                                    Arent: <strong>7,5 triệu/ Tháng</strong>
                                  </span>
                                </div>
                                <div className="info">
                                  <span>
                                    <strong>47,2 triệu/m</strong>{" "}
                                    <sub className="subtop">2</sub>
                                  </span>{" "}
                                  <span>
                                    Trả trước: <strong>700 triệu</strong>
                                  </span>
                                  <span>
                                    Thanh toán:{" "}
                                    <strong>13,2 triệu/tháng</strong>
                                  </span>
                                </div>
                                <div className="location">
                                  {" "}
                                  <span>Hẻm xe hơi</span>{" "}
                                  <span>Đường vào 4,5m (LG 5,0m)</span>
                                </div>
                                <div className="bottom-info">
                                  <span>
                                    <img
                                      src="../../assets/img/cauthang.svg"
                                      alt
                                    />{" "}
                                    3 tầng
                                  </span>
                                  <span>
                                    <img
                                      src="../../assets/img/icons/bx-bed.svg"
                                      alt
                                    />{" "}
                                    2
                                  </span>
                                  <span>
                                    <img
                                      src="../../assets/img/icons/bx-bath.svg"
                                      alt
                                    />{" "}
                                    2
                                  </span>
                      ...
                      <div className="sr-item__poster">
                        ...
                        <div className="box-user">
                          ...
                          <div className="pos">
                            ...
                            <span className="thin">[Chuyên gia</span>{" "}
                            <span className="rating">
                              3,5+ <span className="fa fa-star" />
                          ...
                          <div className="friend pos">
                            ...
                            Bạn chung với{" "}
                            <span className="thick">Trung Hoàng</span>,{" "}
                            <span className="thick">Thuong Huỳnh</span>.
                          </div>
                          <div className="actions">
                              ...
                              >
                                ...
                                <div className="info -ban">
                                  <span>
                                    Avalue:{" "}
                                    <strong>
                                      24.567m <sub className="subtop">2</sub>
                                    </strong>
                                  </span>
                                  <span>
                                  ...
                                  <span>
                                    <strong>1.200 CH</strong>
                                  </span>
                                  <span>
                                    <strong>- - SH</strong>
                                  </span>
                                  <span>
                                    <strong>120 OFT</strong>
                                  </span>
                                  <span>
                                    <strong>
                                      8.467m <sub className="subtop">2</sub>
                                    </strong>
                                  </span>
                                  <span>
                                    <strong>TMDV</strong>
                          ...
                          <div className="item-details__post box-info-line">
                            <div className="row">
                              ...
                              <div className="col-sm-4 col-xs-12 box-right">
                                ...
                                <p className="info-right">
                                  Avalue: 140tr/m{" "}
                                  <span className="subtop">2</span>
                                </p>
                                <p className="info-right">
                                  Gợi ý kinh doanh: Làm khách sạn
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="company-info">
                            <div className="avatar">
                              <span
                                ...
                                style={{
                                  backgroundImage:
                                    "url(https://dongphucocean.vn/wp-content/uploads/2018/12/logo-dong-phuc-ocean.jpg)"
                                }}
                              ></span>
                            </div>
                            <div className="name">Song Kim Land</div>
                            <div className="info">
                              89 Lý Chính Thắng Phường 7, Quận Tân Bình, Hồ Chí
                              Minh
                            </div>
                        ...
                        <div className="item-details__container">
                          ...
                          <div className="item-details__post box-info-line">
                            <div className="box-info-tn">
                              <div className="icon">
                                <img
                                  src="../../assets/img/home/googlepdf@3x.jpg"
                                  alt
                                />
                              </div>
                              <div className="title">
                                Cần thông tin pháp lý khi mua nhà tại quận 2?{" "}
                              </div>
                              <div className="description">
                                Chiều cao, cân nặng hiển thị thông tin từ lịch
                                sử ra. Cho phép sửa đổi và lưu lại thành lịch sử
                                (Thong tin lưu cùng chỗ với thông tin thể lực
                                của bệnh nhân)Bổ sung thêm cột: Thời gian
                                tạo.Danh sách bệnh nhân được order mặc định theo
                                thời gian tạo, từ mới nhất xuống cũ nhất. Khi
                                tạo mới 1 bệnh nhân, mặc định bệnh nhân mới được
                                tạo sẽ được sắp xếp ngày lên đầu tiên
                              </div>
                            </div>
                          </div>
                          <div className="item-details__actions">
        ...
        {/* CHAT SIDEBAR*/}
        <div
          className="d-none d-lg-block chat-sidebar collapsed"
          id="chat-sidebar"
        >
              ...
              <div className="chat-sidebar__top">
                <div className="chat-sidebar--btn-collapse">
                  <div className="btn-expand__content">
                    <button
                      className="btn btn-chat--expand"
                      id="btn-chat--expand"
                    >
                      <img src="../../assets/img/Path 115.png" alt />
                    </button>
                  </div>
                </div>
              </div>
                          ...
                          <div className="contact-items contact-items__active">
                            ...
                            <div className="contact-item d-flex justify-content-center">
                              ...
                              <div className="contact-item--status">
                                <img
                                  src="../../assets/img/icon-chat-active.png"
                                  alt
                                />
                              </div>
                            </div>
                    ...
                    <div className="chat-message__content">
                      <div className="chat-message d-flex justify-content-center align-items-center">
                        <div className="chat-message--icon">
                          <img src="../../assets/img/chat-message.png" alt />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="chat-popup">
                    <div className="chat-popup__container">
                      <div className="chat-popup__content">
                        <div
                          className="chat-popup__items"
                          id="chat-popup__items"
                        >
                          <div className="chat-popup--item">
                            <div className="chat-popup--header d-flex">
                              ...
                              <span className="ml-2 header--text">Test</span>
                              <div className="chat-popup--close">×</div>
                            </div>
                            <div className="chat-popup--body">
                              <div className="message-received">
                                <div className="message-received__content row">
                                  <div className="col-2 px-0 received__content--icon">
                                    <img
                                      src="../../assets/img/chat-avt-1.png"
                                      alt
                                    />
                                  </div>
                                  <div className="col-10 received__content--text">
                                    <span>
                                      KHLCNT của Ban Quản lý dự án đầu tư xây
                                      .... KHLCNT của Sở Tài chính tỉnh Hưng Yên
                                      cho dự án “Mua sắm thiết bị định .... Hạng
                                      mục: Xóm Ao Vàng, Cổ Rùa, Gò Chè, Phúc
                                      Lộc, Quyết Thắng, Tân ...
                                    </span>
                                  </div>
                                  <div className="col-12 received__content--time text-right">
                                    <span>12:09 - 18/10/2019</span>
                                  </div>
                                </div>
                              </div>
                              <div className="message-send">
                                <div className="message-send__content row align-items-end flex-column">
                                  <div className="message-send--text">
                                    <span>OK</span>
                                  </div>
                                  <div className="message-send--time text-right">
                                    <span>1 min</span>
                                  </div>
                                </div>
                              </div>
...
const mapDispatchToProps = dispatch => ({
  postPagination: () => dispatch(fetchCoursesFromDB())
})

export default connect(undefined, mapDispatchToProps)(PostSearchResult);
